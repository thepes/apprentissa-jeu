...
public class LudroidMainActivity extends Activity implements OnInitListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    	if (requestCode == CHECK_TTS_DATA) {
    		...
    		String[] voiceInfo = data.getStringArrayExtra(TextToSpeech.Engine.EXTRA_VOICE_DATA_FILES_INFO);
    		if (null != voiceInfo) {
	...
	public void onInit(int arg0) {
		...
		ttsEngine.speak("Bonjour amour de ma vie ! Je t'aime de tout mon coeur !", TextToSpeech.QUEUE_FLUSH, null);
	}
